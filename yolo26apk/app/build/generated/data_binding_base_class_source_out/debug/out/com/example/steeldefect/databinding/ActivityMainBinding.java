...
package com.example.steeldefect.databinding;
...
import com.example.steeldefect.R;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button captureButton,
      @NonNull PreviewView previewView, @NonNull ImageView resultImageView,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, captureButton, previewView,
          resultImageView, statusText);
    }
